...
#' help \href{https://CRAN.R-project.org/package=CoSMoS/vignettes/vignette.html}{vignette}.
...
#' See the help \href{https://CRAN.R-project.org/package=CoSMoS/vignettes/vignette.html}{vignette}
