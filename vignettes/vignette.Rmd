...
Package CoSMoS supports majority of continuous distributions available in R with defined quantile and probability density function. We provide also four widely used distributions (Burr type III and XII, Generalized gamma and Pareto type II distribution)
...
# References
 ...
 @references Papalexiou, S.M., 2018. Unified theory for stochastic modelling of hydroclimatic processes: Preserving marginal distributions, correlation structures, and intermittency. Advances in Water Resources 115, 234-252. [link](https://doi.org/10.1016/j.advwatres.2018.02.013)
