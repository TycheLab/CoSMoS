...
In this example, a set of five random locations is defined that could represent precipitation in 5 different places. A VAR is then fitted using  
...
From the 5 locations, and the VAR, a set of 5 timeseries is generated. When the series are plotted, the spatio-temporal correlations among the series can be seen.
